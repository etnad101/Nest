...
impl Opcode {
    ...
    pub fn get_opcode_map() -> HashMap<u8, Opcode> {
        let opcodes: Vec<Opcode> = vec![
            ...
            Opcode::new(0xC1, "CMP", 2, 6, AddressingMode::IndirectX), // + 1 cycle if page crossed
            ...
            // Branch
            Opcode::new(0x90, "BCC", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            Opcode::new(0xB0, "BCS", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            Opcode::new(0xF0, "BEQ", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            Opcode::new(0xD0, "BNE", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            Opcode::new(0x10, "BPL", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            Opcode::new(0x30, "BMI", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            Opcode::new(0x50, "BVC", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            Opcode::new(0x70, "BVS", 2, 2, AddressingMode::Relative), // + 1 cycle if branch taken, + 1 if page crossed
            // Jump
            Opcode::new(0x4C, "JMP", 3, 3, AddressingMode::Absolute),
            Opcode::new(0x6C, "JMP", 3, 5, AddressingMode::Indirect),
            Opcode::new(0x20, "JSR", 3, 6, AddressingMode::Absolute),
            Opcode::new(0x60, "RTS", 1, 6, AddressingMode::Implicit),
            Opcode::new(0x00, "BRK", 1, 7, AddressingMode::Implicit), // Only 1 byte wide, but skips the second byte so can be considered 2 bytes
